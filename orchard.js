...
for (let i = 0; i < fujiPounds.length; i++) {
    fujiProfit.push(fujiPounds[i] * 0.89)
    galaProfit.push(galaPounds[i] * 0.64)
    pinkProfit.push(pinkPounds[i] * 0.55)
}
...
for (let i = 0; i < fujiProfit.length; i++) {
   totalProfit += fujiProfit[i]
   totalProfit += galaProfit[i]
   totalProfit += pinkProfit[i]
}
